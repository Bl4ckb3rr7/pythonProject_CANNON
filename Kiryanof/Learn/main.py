...
def draw_eyes(surface, x, y, head_size):
    circle(surface, (0, 0, 255), (x, y), head_size)
...
def draw_hare(surface, x, y, width, height, color):
    '''
    Рисует зайцана экране.
    :param surface: объект pygame.Surface
    :param x: координаты левого верхнего угла изображения
    :param y: координаты левого верхнего угла изображения
    :param width: ширина  изобажения
    :param height:  высота изобажения
    :param color: цвет, заданный в формате, подходящем для pygame.Color
    :return:
    '''
    ...
    for ear_x in (x - head_size // 4, x + head_size // 4):
        ...
        draw_eyes(surface, ear_x, y - ear_y, head_size // 8)
